                ...
                <section>
                    <div className='py-2'>
                        ...
                        <div className='grid grid-cols-2 gap-3  place-items-center justify-center py-[9px] px-2 sm:px-2 bg-white h-[213px] w-full shadow-custom rounded-[5px]'>
                            <Menu style={'bg-pink1 h-[90.549px] w-full'} teks={""} />
                            <Menu style={'bg-pink2 h-[90.549px] w-full'} teks={""} />
                            <Menu style={'bg-primary h-[90.549px] w-full'} teks={""} />
                            <Menu style={'bg-ungu1 h-[90.549px] w-full'} teks={""} />
                        </div>
                    </div>
                </section>
                <section>
